...
<div class="container">
	<div class="navbar navbar-default navbar-static-top" role="navigation">
		<div class="navbar-header">
			...
			<a href="index.php" class="navbar-brand"><img src="images/logo2.png" class="img-responsive" alt="logo"></a>
		</div>
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="membership.php" <?php if($page=='membership'){ ?> class="active" <?php } ?>>ABONNEMENTS</a></li>
