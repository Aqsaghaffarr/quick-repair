            ...
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-3 js-datepicker" type="text" placeholder="Date" name="date">
                        ...
                        <div class="input-group">
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="evaluation">
                                    <option disabled="disabled" selected="selected">Type d'évaluation</option>
                                    <option>Apprendre à réparer votre propre appareil</option>
                                    <option>Attribuer votre appareil à nos meilleurs techniciens</option>
                                </select>
                                <div class="select-dropdown"></div>
                            </div>
                        </div>
