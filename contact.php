	...
	<div class="container">
		<div class="row">
			<div class="col-md-offset-2 col-md-8 col-sm-12">
				<h2>Get in touch</h2>
                <p>Pour plus d'informations, vous pouvez nous contacter via le formulaire de contact suivant</p>
			</div>
			...
			<div class="col-md-4 col-sm-4 address">
				<div>
					<h3>Email</h3>
					<p>info@quickrepair.com</p>
				</div>
				<div>
					<h3>Phones</h3>
					<p>+32-000-00-00-00 | +32-000-00-00-00</p>
				</div>
			</div>
